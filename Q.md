...
you have to implement corresponding functions in `internal/bgp` package. take a look on style how the `bgp-dnsctl cache list` was implemented. use the existing logging infrastructure to print to stdout.
